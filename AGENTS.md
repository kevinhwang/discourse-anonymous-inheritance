...
Adhere to standard Discourse (rubocop-discourse) ecosystem code style and conventions.
...
- Always `rubocop-discourse` changed files.

### Testing

This is a Discourse plugin that patches Discourse functionality, so most tests are integration tests requiring standing up a Discourse instance. Because of this, the easiest way to test is to open a PR to the main branch and watch the CI run.
